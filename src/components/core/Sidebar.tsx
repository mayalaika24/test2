...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={sidebarEl}
        className={`shadow-lg relative h-full md:py-12 py-9 overflow-y-auto overflow-x-hidden bg-white flex flex-col justify-between transition-all duration-700 ease-break ${isOpen ? 'md:w-side w-12' : 'w-12'}`}
      >
